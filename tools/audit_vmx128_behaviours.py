...
# residual corruption to. One immediate pair is not a test of an immediate.
# mask 0x3 = 0b0011 -> elements 0,1 from vD and 2,3 from the rotated vB;
# rotate 2 -> rotated[i] = vB[(i+2)&3], so elements 2,3 are vB[0], vB[1].
CASES.append({
    "name": "vrlimi128-mask3-rot2",
    "function": 0x820A9BC4,
    "vec": {"vr13": VA, "vr12": VB},
    "capture": "vr13",
    "expect": VA_W[0] + VA_W[1] + VB_W[0] + VB_W[1],
})
