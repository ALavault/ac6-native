// Read-only assertions for the AC6 PAL 0x821F0AD0 configured split.
// @category AC6
...
public class Verify821F0AD0Boundary extends GhidraScript {
    ...
    private void require(long value, String mnemonic, String fragment)
        ...
        assertions++;
        println("AC6_821F0AD0_CONTRACT=" + address + " " + instruction);
    }
    ...
    private void requireNoReferences(long value) {
        ...
        assertions++;
        println("AC6_821F0AD0_NO_REFERENCES=" + address);
    }
    ...
    private void requireFunctionEntry(long value) {
        ...
        assertions++;
        println("AC6_821F0AD0_FUNCTION_ENTRY=" + function.getEntryPoint());
    }
    ...
    private void requireNoFunctionEntry(long value) {
        ...
        assertions++;
        println("AC6_821F0AD0_NO_FUNCTION_ENTRY=" + address);
    }
    ...
    public void run() throws Exception {
        ...
        // The sole frame owner precedes both the loop head and candidate.
        ...
        // 0x821F0AD0 consumes the offset derived by the immediately preceding
        // instructions. It has no incoming reference or independent prologue.
        ...
        requireNoReferences(0x821f0ad0L);
        ...
        // Same frame continues through the following nested loop family.
        ...
        println("AC6_821F0AD0_ASSERTIONS=" + assertions);
    }
}
