...
class QueueConsumerStack(gdb.Breakpoint):
    def __init__(self):
        self.hits = 0
    ...
    def stop(self):
        try:
            ...
            try:
                ...
                pass
            print('AC6_QUEUE_CONSUMER_STACK hit=%d tick=%s thread=%s '
                  'r1=0x%08x r3=0x%08x r4=0x%08x r5=0x%08x '
                  'r6=0x%08x r7=0x%08x r30=0x%08x r31=0x%08x '
                  'lr=0x%08x' %
                  (self.hits, tick, thread, gpr(1), gpr(3), gpr(4),
                   gpr(5), gpr(6), gpr(7), gpr(30), gpr(31),
            ...
            print('AC6_QUEUE_CONSUMER_STACK_ERROR %s' % exc)
        return False
