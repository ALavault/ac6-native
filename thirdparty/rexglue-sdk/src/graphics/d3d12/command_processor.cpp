...
bool D3D12CommandProcessor::IssueDraw(xenos::PrimitiveType primitive_type, uint32_t index_count,
  ...
  ac6::backend::ReportHostIssueCalled(ac6::backend::BackendDrawApi::kD3D12);
  auto draw_result = [](bool success) {
    return ac6::backend::ReportBackendIssueResult(
        ac6::backend::BackendDrawApi::kD3D12, success);
  };
  ...
  if (primitive_processing_result.index_buffer_type ==
    ...
    deferred_command_list_.D3DDrawInstanced(primitive_processing_result.host_draw_vertex_count, 1,
                                            0, 0);
    ac6::backend::ReportHostDrawEmitted(ac6::backend::BackendDrawApi::kD3D12);
  } else {
