...
void CommandProcessor::WorkerThreadMain() {
  ...
  while (worker_running_) {
    ...
    frame_loop_telemetry::CountPrimaryBufferExecution(read_ptr_index_);
...
void CommandProcessor::UpdateWritePointer(uint32_t value) {
  frame_loop_telemetry::CountWritePointerUpdate(value);
...
bool CommandProcessor::ExecutePacketType3_INTERRUPT(memory::RingBuffer* reader, uint32_t packet,
  ...
  frame_loop_telemetry::CountPm4InterruptPacket();
...
bool CommandProcessor::ExecutePacketType3_XE_SWAP(memory::RingBuffer* reader, uint32_t packet,
  ...
  frame_loop_telemetry::CountPm4SwapPacket();
